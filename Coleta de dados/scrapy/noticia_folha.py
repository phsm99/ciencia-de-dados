...
class ColetanoticiaFolhaSpider(scrapy.Spider):
    name = 'noticia_folha'
    ...
    def parse(self, response):
        for noticia_site in response.xpath('//ol[@class="u-list-unstyled"]/li'):
            nome = noticia_site.css(".c-headline__title::text").get()
            resumo = noticia_site.css(".c-headline__standfirst::text").get()
            data = noticia_site.css(".c-headline__dateline::text").get()
